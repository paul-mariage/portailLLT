...
<title>Outil de reporting Leroux et Lotz - Login Envoyé</title>
</head>
...
<body>
	...
	<br><br><br><br>
	<h1 style="FONT-SIZE: xx-large" align=center ><b>Login Envoyé!</b></h1>
	<br><br>
	<br><br><center>
	<% if(request.getSession().getAttribute("user") == null){
		...
		Votre login a été renvoyé à votre adresse.<br>
